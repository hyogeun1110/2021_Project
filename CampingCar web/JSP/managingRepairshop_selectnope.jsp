...
%>
  <br><br>
  <button type="button" class="button" style="width:300px; background:#46BEFF; padding:10px; margin-left : 100px ; display: inline-block;"onclick="location.href='managingRepairshop_select.jsp'">Repairtshop Main</button>
  <button type="button" class="button" style="width:300px; background:#16c288; padding:10px; margin-left : 700px ; display: inline-block;"onclick="location.href='adminMain.jsp'">Manager Main</button>
  <br><br>
<%
...
ResultSet myRS = null;
 try{
  ...
  String sql = "select * from repairshop where RS_STATE='미사용' order by rs_id ASC";
