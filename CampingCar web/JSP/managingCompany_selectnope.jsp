...
<%
  ...
  <br><br>
  <button type="button" class="button" style="width:300px; background:#46BEFF; padding:10px; margin-left : 200px ; display: inline-block;"onclick="location.href='managingCompany_select.jsp'">Company Main</button>
  <button type="button" class="button" style="width:300px; background:#1a6a79; padding:10px; margin-left : 600px ;color:white; display: inline-block;"onclick="location.href='adminMain.jsp'">Manager Main</button>
...
ResultSet myRS = null;
 try{
  ...
  String sql = "select * from COMPANY where C_STATE='미사용' order by c_id DESC";
            ...
            <div class="card">
              ...
              <div class="rightside">
                ...
                <h3><%=cId%></h3>
                  ...
                  <button type="button" class="button2" onclick="location.href='managingCompany_usePro.jsp?cId=<%=cId%>'">use</button>
                </form>
              </div>
            </div>
          </div>
