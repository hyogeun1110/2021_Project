...
<div class="top">
   ...
   <input type="button" class="btnok btn-outline-primary" onclick="location='PastReservationCheck.jsp'" style="top:55px; left: 940px; z-index:3;" value="지난내역보기">
<%
  ...
  <div class="container">
    <form method="post" action="ReservationChange.jsp">
      <div class="middle">
        ...
        <input type="submit" class="btnok btn-outline-primary"  style="top:30px; left: 280px;" value="예약변경">

        <input type="button" class="btnok btn-outline-primary" onclick="location='Main.jsp'" style="top:30px; right: 280px;" value="처음으로">
      </div>
    </form>
  </div>
