...
<%
    ...
    String z = "";
    if(op.equals("a")){
        count = dbPro.getArticleCountSelCon(sl);
        articleList = dbPro.getArticlesSelectCon(sl,startRow, pageSize);
        z = "(제목)";
    }
    else{
        count = dbPro.getArticleCountSelUser(sl);
        articleList = dbPro.getArticlesSelectUser(sl,startRow, pageSize);
        z = "(작성자)";
    }
...
<div class="container">
    <div class="alert alert-primary" role="alert">
        <h1><i class="fas fa-list"></i> 검색어<%=z%> : <%=sl%></h1>
