...
<%
    ...
    count = dbPro.getArticleCountMe(id);
    BoardDataBean article1 = dbPro.NameArticle(id);
    
    if (count > 0) {
        articleList = dbPro.getArticlesMe(id,startRow, pageSize);
    }
...
<div class="container">
    <div class="alert alert-primary" role="alert">
        <h1><i class="fas fa-list"></i> 글목록(나의 글:<%=count%>)</h1>
        ...
        <button class="btn btn-dark" style="border:0; border-radius:12px; font-size:13px; font-weight:bold; position:relative; top:15px;" onclick="location='list3.jsp'">나의 댓글</button>
